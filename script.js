...
console.log(result); //Escribe tu código aquí;
...
const value = "1";
const tipo = typeof value; // tipo = string
...
//Ejercicio 10: Con un bucle for in imprime en pantalla todos los nombres, apellidos y su aporte a la sociedad de las programadoras de la historia contenidas en el array llamado 'programmers',
// Deberás imprimir el índice y la información de cada una de ellas de la siguiente manera: '0: Ada Lovelace, su aporte fue la máquina analítica'.
...
//Escribe tu código aquí
for (const key in programmers) {
  const element = programmers[key];
  console.log(
    key +
      ": " +
      element.name +
...
for (const element of names) {
  console.log("Hola, mi nombre es: " + element);
}
...
//Crea una función llamada saludar que tome un parámetro llamado nombre y devuelva un saludo personalizado.
// Luego, llama a la función con diferentes nombres y muestra el resultado en la consola.
...
//Crea una función llamada calcularAreaRectangulo que tome dos parámetros (ancho y alto) y devuelva el área del rectángulo.
// Luego, llama a la función con diferentes valores de ancho y alto y muestra el resultado en la consola.
...
console.log("El área es: " + calcularAreaRectangulo(20, 40));
console.log("El área es: " + calcularAreaRectangulo(5, 10));
